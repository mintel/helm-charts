...
{{- $terraformCloudResources := (list "activeMQ" "apiGatewayHttp" "auroraMySql" "auroraPostgresql" "cmsBackup" "datasync" "dynamodb" "extraIAM" "glue" "kinesis-firehose" "lambda" "mariadb" "memcached" "opensearch" "postgresql" "redis" "s3" "s3ReplicationRules" "s3MultiRegionAccessPoint" "sns" "sqs" "sshKeyPairSecret" "staticWebsite" "stepFunctionEks") -}}
