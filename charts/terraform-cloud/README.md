...
| auroraPostgresql.terraform.module.source | string | `"app.terraform.io/Mintel/rds/aws"` | Registry path of the Terraform module used to create the resource (https://app.terraform.io/app/Mintel/registry/modules/private/Mintel/rds-aurora/aws) |
| auroraPostgresql.terraform.module.version | string | `"0.0.2"` | Module version |
