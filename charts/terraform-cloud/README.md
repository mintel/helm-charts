...
| extraIAM.terraform | object | `{"defaultVars":{},"instances":{},"module":{"source":"app.terraform.io/Mintel/app-iam/aws","version":"2.1.0"}}` | Set ArgoCD syncWave for this resource (default -20) syncWave: -20 |
...
| extraIAM.terraform.module.version | string | `"2.1.0"` | Module version |
