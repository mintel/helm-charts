...
| irsa.terraform | object | `{"module":{"source":"app.terraform.io/Mintel/app-iam/aws","version":"2.3.0"},"vars":{}}` | Set ArgoCD syncWave for this resource (default -20) syncWave: -20 |
...
| irsa.terraform.module.version | string | `"2.3.0"` | Module version |
