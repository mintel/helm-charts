...
| extraIAM.terraform | object | `{"defaultVars":{},"instances":{},"module":{"source":"app.terraform.io/Mintel/app-iam/aws//modules/entrypoint","version":"3.4.1"}}` | Set ArgoCD syncWave for this resource (default -20) syncWave: -20 |
...
| extraIAM.terraform.module.source | string | `"app.terraform.io/Mintel/app-iam/aws//modules/entrypoint"` | Registry path of the Terraform module used to create the resource (https://app.terraform.io/app/Mintel/registry/modules/private/Mintel/app-iam/aws) |
| extraIAM.terraform.module.version | string | `"3.4.1"` | Module version |
...
| glue.enabled | bool | `false` | Set to true to create a Glue integration |
| glue.outputSecret | bool | `true` | Set to true to create an AWS secret manager external secret with outputs |
| glue.terraform | object | `{"defaultVars":null,"instances":{},"module":{"source":"app.terraform.io/Mintel/glue/aws//modules/entrypoint","version":"1.3.1"},"terraformVersion":"1.4.3"}` | Set ArgoCD syncWave for this resource (default -40) syncWave: -40 |
| glue.terraform.defaultVars | string | See below | Vars to be applied to all instances defined below |
| glue.terraform.instances | object | `{}` | A map of instance names => variable key/value pairs to be sent to the terraform module. The values in `defaultVars` will be applied to every instance if not explicitly defined here. |
...
| irsa.terraform | object | `{"module":{"source":"app.terraform.io/Mintel/app-iam/aws//modules/entrypoint","version":"3.4.1"},"notifications":[{"enabled":true,"name":"tfcloud-auto-approver","token":"${TFCLOUD_AUTO_APPROVER_SIGNATURE_KEY}","triggers":["run:needs_attention"],"type":"generic","url":"${TFCLOUD_AUTO_APPROVER_URL}"}],"vars":{}}` | Set ArgoCD syncWave for this resource (default -20) syncWave: -20 |
| irsa.terraform.module.source | string | `"app.terraform.io/Mintel/app-iam/aws//modules/entrypoint"` | Registry path of the Terraform module used to create the resource (https://app.terraform.io/app/Mintel/registry/modules/private/Mintel/app-iam/aws) |
| irsa.terraform.module.version | string | `"3.4.1"` | Module version |
...
| lambda.terraform | object | `{"defaultVars":null,"instances":{},"module":{"source":"app.terraform.io/Mintel/lambda/aws","version":"8.0.1"},"terraformVersion":"1.4.3"}` | Set ArgoCD syncWave for this resource (default -40) syncWave: -40 |
...
| lambda.terraform.module.version | string | `"8.0.1"` | Module version |
...
| memcached.terraform | object | `{"defaultVars":{"instance_type":"cache.t4g.micro","num_cache_nodes":1},"instances":{},"module":{"source":"app.terraform.io/Mintel/memcached/aws","version":"1.0.3"}}` | Set ArgoCD syncWave for this resource (default -40) syncWave: -40 |
...
| redis.terraform | object | `{"defaultVars":{},"instances":{},"module":{"source":"app.terraform.io/Mintel/redis/aws","version":"1.3.0"}}` | Set ArgoCD syncWave for this resource (default -40) syncWave: -40 |
...
| redis.terraform.module.version | string | `"1.3.0"` | Module version |
...
| s3ReplicationRules.terraform.defaultVars | object | `{}` | Vars to be applied to all instances defined below |
| s3ReplicationRules.terraform.instances | object | `{}` | A map of instance names => variable key/value pairs to be sent to the terraform module. The values in `defaultVars` will be applied to every instance if not explicitly defined here. |
| s3ReplicationRules.terraform.module.source | string | `"app.terraform.io/Mintel/s3-replication-rules/aws//modules/entrypoint"` | Registry path of the Terraform module used to create the resource (https://app.terraform.io/app/Mintel/registry/modules/private/Mintel/s3-replication-rules/aws) |
| s3ReplicationRules.terraform.module.version | string | `"0.1.0"` | Module version |
| s3ReplicationRules.terraform.terraformVersion | string | `"1.8.1"` |  |
