...
| irsa.terraform | object | `{"module":{"source":"app.terraform.io/Mintel/app-iam/aws","version":"0.1.0-beta.8"},"vars":{}}` | Set to true to explicitly instantiate this module if there's need to access resources created elsewhere enabled: false |
| irsa.terraform.module | object | `{"source":"app.terraform.io/Mintel/app-iam/aws","version":"0.1.0-beta.8"}` | Set override to stop IRSA from ending in global.name nameOverride: |
...
| opensearch.terraform.defaultVars | object | `{}` | Automatically set to true in prod and false in dev and qa. Override this only if you know what you're doing. zone_awareness_enabled: bool |
...
| opensearch.terraform.module | object | `{"source":"app.terraform.io/Mintel/opensearch/aws","version":"0.1.0-beta.3"}` | Set Terraform version for this module to overwrite global.TerraformVersion terraformVersion: |
...
| opensearch.terraform.module.version | string | `"0.1.0-beta.3"` | Module version |
...
| redis.terraform.defaultVars | object | `{}` | Automatically set to true in prod and false in dev and qa. Override this only if you know what you're doing. enable_multi_az: bool |
...
| redis.terraform.module | object | `{"source":"app.terraform.io/Mintel/redis/aws","version":"0.1.0-beta.4"}` | Set Terraform version for this module to overwrite global.TerraformVersion terraformVersion: |
...
| s3.terraform.defaultVars | object | `{}` | Automatically set to true in prod and false in dev and qa. Override this only if you know what you're doing. enable_versioning: bool |
...
| sqs.terraform.module | object | `{"source":"app.terraform.io/Mintel/sqs/aws","version":"0.0.1-alpha.23"}` | Set Terraform version for this module to overwrite global.TerraformVersion terraformVersion: |
