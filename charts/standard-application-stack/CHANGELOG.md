...
## [v11.4.1] - 2026-09-09
### Fixed
- Include `envFrom` `secretRef` names in Stakater Reloader annotations so deployments that consume shared secrets restart when those secrets change.
...
## [v11.0.1] - 2025-12-15
### Fixed
- Celery volumeMount bug.

## [v11.0.0] - 2025-11-07
### Changed
- Add support for using Mimir (by default) via the prometheus scaler.

## [v10.5.0] - 2025-08-19
### Added
- Added support for `backstage.component` being set on `Service` resource. Can be used to help route ALB alerts
