...
| otel.python.extraEnv | list | `[{"name":"OTEL_PYTHON_EXCLUDED_URLS","value":"/health[zy]?,/ready[z]?,/readiness,/external-health-check,/metrics"}]` | Additional Python specific vars to add to the pod |
