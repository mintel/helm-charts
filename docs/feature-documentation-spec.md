...
- [1. Workload basics](#1-workload-basics)
  - [1.1 Changing the number of replicas](#11-changing-the-number-of-replicas)
  - [1.2 Choosing Deployment vs StatefulSet](#12-choosing-deployment-vs-statefulset)
  - [1.3 Setting the container image and pull policy](#13-setting-the-container-image-and-pull-policy)
  - [1.4 Setting container command, args, and env](#14-setting-container-command-args-and-env)
  - [1.5 Configuring resource requests and limits](#15-configuring-resource-requests-and-limits)
  - [1.6 Configuring liveness and readiness probes](#16-configuring-liveness-and-readiness-probes)
  - [1.7 Configuring security context](#17-configuring-security-context)
  - [1.8 Configuring rollout strategy](#18-configuring-rollout-strategy)
  - [1.9 Adding init containers and extra containers](#19-adding-init-containers-and-extra-containers)
  - [1.10 Adding volumes and mounts](#110-adding-volumes-and-mounts)
  - [1.11 Running with only CronJobs or only Jobs](#111-running-with-only-cronjobs-or-only-jobs)
  - [1.12 Configuring pod metadata and extra ports](#112-configuring-pod-metadata-and-extra-ports)
  - [1.13 Configuring lifecycle hooks and ALB preStop delay](#113-configuring-lifecycle-hooks-and-alb-prestop-delay)
  - [1.14 Celery and Celery Beat workloads](#114-celery-and-celery-beat-workloads)
- [2. Service and networking](#2-service-and-networking)
  - [2.1 Enabling or disabling the Service](#21-enabling-or-disabling-the-service)
  - [2.2 Configuring an ingress for direct public access](#22-configuring-an-ingress-for-direct-public-access)
  - [2.3 Configuring an ingress for API gateway (path-based routing)](#23-configuring-an-ingress-for-api-gateway-path-based-routing)
  - [2.4 Setting frontend tier without ingress](#24-setting-frontend-tier-without-ingress)
  - [2.5 Exposing the app via a Network Load Balancer](#25-exposing-the-app-via-a-network-load-balancer)
  - [2.6 Configuring network policy](#26-configuring-network-policy)
  - [2.7 OAuth proxy sidecar](#27-oauth-proxy-sidecar)
- [3. Scaling and resilience](#3-scaling-and-resilience)
  - [3.1 Enabling autoscaling (KEDA)](#31-enabling-autoscaling-keda)
  - [3.2 Configuring Pod Disruption Budget](#32-configuring-pod-disruption-budget)
  - [3.3 Configuring Vertical Pod Autoscaler](#33-configuring-vertical-pod-autoscaler)
  - [3.4 Configuring topology spread and affinity](#34-configuring-topology-spread-and-affinity)
- [4. Identity and RBAC](#4-identity-and-rbac)
  - [4.1 Service account and IRSA](#41-service-account-and-irsa)
  - [4.2 Roles and ClusterRoles](#42-roles-and-clusterroles)
  - [4.3 Kubelock](#43-kubelock)
- [5. Secrets and backends (standard-application-stack)](#5-secrets-and-backends-standard-application-stack)
  - [5.1 Main app External Secret](#51-main-app-external-secret)
  - [5.2 Using Terraform-managed backend secrets](#52-using-terraform-managed-backend-secrets)
  - [5.3 MariaDB / PostgreSQL / Redis / S3 / DynamoDB / SQS / Elasticsearch / OpenSearch](#53-mariadb--postgresql--redis--s3--dynamodb--sqs--elasticsearch--opensearch)
- [6. Scheduled and one-off workloads](#6-scheduled-and-one-off-workloads)
  - [6.1 CronJobs](#61-cronjobs)
  - [6.2 One-off Jobs](#62-one-off-jobs)
  - [6.3 Hiding the main deployment](#63-hiding-the-main-deployment)
- [7. Observability and instrumentation](#7-observability-and-instrumentation)
  - [7.1 Prometheus metrics (ServiceMonitor / PodMonitor)](#71-prometheus-metrics-servicemonitor--podmonitor)
  - [7.2 OpenTelemetry](#72-opentelemetry)
- [8. Sidecars and local dev](#8-sidecars-and-local-dev)
  - [8.1 Filebeat sidecar](#81-filebeat-sidecar)
  - [8.2 Git-sync sidecar](#82-git-sync-sidecar)
  - [8.3 Localstack / Mailhog / Event Bus](#83-localstack--mailhog--event-bus)
- [9. Entra and ConfigMaps](#9-entra-and-configmaps)
  - [9.1 Entra (Azure AD) Application and Service Principal](#91-entra-azure-ad-application-and-service-principal)
  - [9.2 ConfigMaps](#92-configmaps)
- [10. Terraform Cloud (infrastructure as code)](#10-terraform-cloud-infrastructure-as-code)
  - [10.1 Enabling a Terraform Cloud resource type](#101-enabling-a-terraform-cloud-resource-type)
  - [10.2 Outputting workspace outputs to Kubernetes secrets](#102-outputting-workspace-outputs-to-kubernetes-secrets)
  - [10.3 IRSA via Terraform Cloud](#103-irsa-via-terraform-cloud)
  - [10.4 Global Terraform settings](#104-global-terraform-settings)
- [11. Naming and labels](#11-naming-and-labels)
  - [11.1 Application name and fullname](#111-application-name-and-fullname)
